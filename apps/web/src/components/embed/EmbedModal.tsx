      ...
      {!isPublic ? (
        ...
        <div className="space-y-5">
          ...
          <div>
            ...
            <div className="rounded-xl border border-border bg-[#0B1120] p-4 flex justify-center overflow-hidden">
              {!imgLoaded && !imgError && (
              ...
              <img
                ...
                className={`w-full h-auto transition-opacity duration-300 ${imgLoaded ? 'opacity-100' : 'opacity-0 absolute'}`}
