  ...
  return (
    <section className="py-20 sm:py-32 px-4 sm:px-6">
      <div className="max-w-4xl mx-auto">
        <p className="text-xs tracking-[0.2em] uppercase text-muted-foreground/60 text-center mb-3">
          How it works
        </p>
        ...
        <div className="grid md:grid-cols-3 gap-px bg-border/50 rounded-2xl overflow-hidden border border-border/50">
          {steps.map((step) => (
            <div key={step.number} className="relative p-8 bg-background group">
              <span className="text-[11px] font-mono tracking-wider text-primary/40 mb-4 block">
                {step.number}
              </span>
